				    ...
				    <h2>find Address :</h2>
      				<address>
						 ...
						 <p>Bangladesh</p>
				 	 	...
				 	 	<p>Email: <a href="mailto:info@mycompany.com">info(at)smUniversity.com</a></p>
				  ...
				  <div class="contact-form">
				  	<h2>Contact Us</h2>
					    <form method="post">
						   ...
						   <div>
                                                       <label class="fa-btn btn-1 btn-1e"><input type="submit" value="submit us" onclick="tell()"></label>
                                                       <script>
                                                           function tell(){
