    ...
    <body>
        ...
        <div class="containerTemp" style="max-width: 100%">
            <div class="description">
                <p>SM University is one of the top university of Bangladesh. We offer top quality educational facilities. We have qualified faculties and they are 
            ...
            <div class="underGrad" style="height: 150%;">
                ...
                <div class="row">
                    <div class="col-sm-7" style="background: #f4f4f4; position: relative; margin-top: 5%; margin-left: 5%;">
                        ...
                        <div>
                            <span class="admisFake" onclick="show('admisU')">Undergraduate Admission <i class="fa fa-angle-double-right"></i></span>
                        </div>
                        <div class="list-group col-sm-4" id="admisU" style="display: none; margin-top: 3px">
                            <a href="info.php" class="list-group-item">Info</a>
                          <a href="admissionForm.php" class="list-group-item">Apply for exam</a>
                        </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6" style="background: #f4f4f4; position: relative; margin-top: 8%; margin-left: 30%; ">
                        <div class="inside" style="padding: 32px; font-size: 15px">
                                ...
                                <div> <span class="admisFake" onclick="show('admisP')">Postgraduate Admission <i class="fa fa-angle-double-right"></i></span> </div>
